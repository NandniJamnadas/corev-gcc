...
(define_insn "riscv_cv_simd_neg_h_si"
	[(set (match_operand:SI 0 "register_operand" "=r")
		(unspec:SI [(minus:SI (const_int 0) (match_operand:SI 1 "register_operand" "r"))]UNSPEC_CV_NEG_H))]
	"TARGET_XCVSIMD && !TARGET_64BIT"
	"cv.sub.h\\t%0,%1"
	[(set_attr "type" "arith")
	(set_attr "mode" "SI")])
...
(define_insn "riscv_cv_simd_neg_b_si"
	[(set (match_operand:SI 0 "register_operand" "=r")
		(unspec:SI [(minus:SI (const_int 0) (match_operand:SI 1 "register_operand" "r"))]UNSPEC_CV_NEG_B))]
	"TARGET_XCVSIMD && !TARGET_64BIT"
	"cv.sub.b\\t%0,%1"
	[(set_attr "type" "arith")
	(set_attr "mode" "SI")])
